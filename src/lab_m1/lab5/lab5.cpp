...
void Lab5::Update(float deltaTimeSeconds)
{
...

    {
        ...
        modelMatrix = glm::rotate(modelMatrix, RADIANS(90.f), glm::vec3(1.f, 1.5f, 0));
        modelMatrix = glm::scale(modelMatrix, glm::vec3(1.f, .9f, .5f));
...

    {
        glm::mat4 modelMatrix = glm::mat4(1);
		modelMatrix = glm::translate(modelMatrix, glm::vec3(-2, 2, 0));
        modelMatrix = glm::rotate(modelMatrix, RADIANS(180.f), glm::vec3(0.7f, -0.3f, 0.3f));
        modelMatrix = glm::scale(modelMatrix, glm::vec3(.8f, 1, .9f));
        RenderMesh(meshes["sphere"], shaders["VertexNormal"], modelMatrix);
    }
